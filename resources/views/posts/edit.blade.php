    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-primary">
                <div class="panel-heading"><h3><center>Edit Post</center></h3></div>
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/posts/{{$posts->id}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{method_field('PUT')}} 
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body" rows="5" class="form-control" name="post_body" required>{{ $posts->post_body }}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('category_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id="category_id" type="category_id" class="form-control" name="category_id" value="{{ $posts->category_id }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('post_image') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="post_image" type="file" class="form-control" name="post_image" autofocus>{{ $posts->post_image }}
